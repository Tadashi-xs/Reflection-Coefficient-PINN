...
<div style="border: 2px solid #000000; background: #f9f9f9; padding: 12px; border-radius: 8px; display: inline-block;">
$$
...
| $\operatorname{Re}(\mu)$ | Действительная часть поляризуемости |
| $\operatorname{Im}(\mu)$ | Мнимая часть поляризуемости |

## Выходные данные

| Обозначение | Параметр |
| - | - |
| $\operatorname{Re}(\zeta_1)$ | Действительная часть амплитуды первой цепочки |
| $\operatorname{Im}(\zeta_1)$ | Мнимая часть амплитуды первой цепочки |
| $\operatorname{Re}(\zeta_2)$ | Действительная часть амплитуды второй цепочки |
| $\operatorname{Im}(\zeta_2)$ | Мнимая часть амплитуды второй цепочки |